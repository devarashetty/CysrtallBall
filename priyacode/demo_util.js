...
function drawKeypoints(keypoints, minConfidence, ctx, scale = 1) {
  ...
  if( keypoints[3].score > minConfidence &&  keypoints[4].score > minConfidence){
    const x1 = keypoints[3].position.x;
    const y1 = keypoints[3].position.y;
    const x2 = keypoints[4].position.x;
    const y2 = keypoints[4].position.y;
  ...
  if( keypoints[1].score > minConfidence &&  keypoints[2].score > minConfidence){
    const ex1 = keypoints[1].position.x;
    const ey1 = keypoints[1].position.y;
    const ex2 = keypoints[2].position.x;
    const ey2 = keypoints[2].position.y;
    var dex= Math.abs(ex1-ex2);
    var dey= Math.abs(ey1-ey2);
    var elen=Math.sqrt(dex*dex+dey*dey);
    arrEye.push(elen);
  }
}
